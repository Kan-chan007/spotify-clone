...
class ApiClient {
    ...
    public static void main(String[] args) {
        ...
        String musicUrl = "https://itunes.apple.com/search?term=diljit+dosanjh&limit=25";
        ...
        try {
            ...
            for (int i = 0; i < songList.size(); i++) {
                System.out.println(songList.get(i).songName);
                System.out.println(songList.get(i).singerName);
                System.out.println(songList.get(i).songUrl);
                System.out.println(songList.get(i).songImageUrl);

            }

            AppFrame frame = new AppFrame(songList);
